...
/** 
 *Cierra una sala de chat privada
 *ID de la sala a cerrar
 */
...
/** 
 *Creamos una sala privada
 *Información para crear la sala
 */
const chatTo = data => {
  ...
  if (existChat === EMPTY) {
    if (user.dataset.idhtml !== selectorID || data.idDestinoHTML !== data.idOrigenHTML) {
      ...
      span.classList.add('has-text-black', 'chatUser');
...
/** 
 *Seleccionar una sala para charlar
 *Evento implicito en la acción ejecutada
 */
 ...
 *Evento implicito en la acción ejecutada
 * Indicamos el estado para saber que usuario esta escribiendo
 */
 ...
 *Información que pinta cuando pulsamos un tecla
 */
...
/** 
 *Muestra texto en el chat general
 ...
 *Información de cada uno de los usuarios
 */
 ...
 *  Información sobre la subida del archivo
 */
